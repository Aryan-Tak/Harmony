        ...
        <div id="swiper-container" className="w-full lg:w-2/3 flex flex-col m-2 p-2 justify-center items-center relative">
          <div id="card-container" className="relative w-full lg:w-auto flex flex-col items-center">
            ...
            <link
              ...
              rel="stylesheet"
            />
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" integrity="sha512-SnH5WK+bZxgPHs44uWIX+LLJAJ9/2PkPKJ5QiAj6Ta86w+fsb2TkcmfRyVX3pBnMFcV7oQPJkl9QevSCWr3W6A==" crossOrigin="anonymous" referrerPolicy="no-referrer" />
